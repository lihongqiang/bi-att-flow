...
# PARAMETERS 
###############################################################################
input_filename = "/home/t-tiayi/msproj/data/EQnA_QnARepro_L4_ranker_test1.tsv"
output_filename = "525154"
query_field = "query"
passage_field = "passage"
output_field = "similarity"
model_name = "./model/q2p_tf_model_525154/q2p_tf.ckpt-1"
    ...
    for l in f_in:
        ...
        if len(lines) >= 1000:
            ...
            for i in range(0, len(lines)):
                f_out.write(lines[i] + "\t" + str(float(probs[i][1])) + "\n")
