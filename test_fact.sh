...
#python -m basic.cli_test --len_opt --cluster  --topk=0 --out_dir=/home/t-honli/bi-att-flow/out/EQnA/03-07-2017 --data_dir=data/EQnA/no_sent_token --model_name=EQnA
 python -m basic.cli_test --len_opt --cluster  --topk=0 --out_dir=/home/t-honli/bi-att-flow/out/fact --data_dir=data/fact/ --load_path=/home/t-honli/bi-att-flow/out/fact/save/save-72000 --model_name=fact
